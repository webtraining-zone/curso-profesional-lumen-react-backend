...
CREATE TABLE `issues` (
  ...
  `type` enum('TASK','IMPROVEMENT','STORY','GOAL','BUG','REQUIREMENT') COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('OPEN','IN_PROGRESS','RESOLVED','CLOSED') COLLATE utf8mb4_unicode_ci NOT NULL,
  `priority` enum('BLOCKER','CRITICAL','MINOR','TRIVIAL') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `issues_project_id_foreign` (`project_id`),
  KEY `issues_reporter_foreign` (`reporter`),
  KEY `issues_assignee_foreign` (`assignee`),
  CONSTRAINT `issues_assignee_foreign` FOREIGN KEY (`assignee`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `issues_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  CONSTRAINT `issues_reporter_foreign` FOREIGN KEY (`reporter`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
INSERT INTO `migrations` VALUES (13,'2018_10_05_143812_create_users_table',1),(14,'2018_10_05_143824_create_projects_table',1),(15,'2018_10_05_143947_create_issues_table',1);
